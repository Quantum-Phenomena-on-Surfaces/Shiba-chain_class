...
def Self_Energy(J, S, thetaS, phi, U, N_atoms, N_x, N_y, layers, borde, lamda):
     ...
     #Self = lil_matrix((N_x * N_y * layers, N_x * N_y * layers, 4, 4), dtype= complex)
     #Self2 = lil_matrix((N_x * N_y * layers * 4, N_x * N_y * layers * 4), dtype= complex)
...
#     for i_matrix in range(N_y): #splitted in two for chain with +- Rashba
#         for j_matrix in range(int(N_x/2), N_x -1):
#            
#             g_i = (i_matrix)*N_x + j_matrix
#             g_j = (i_matrix)*N_x + (j_matrix + 1)
#            
...
#     for i_matrix in range(N_y - 1):
#         for j_matrix in range(int(N_x/2), N_x):
#            
#             g_i = (i_matrix)*N_x + j_matrix
#             g_j = (i_matrix + 1)*N_x + j_matrix
#            
